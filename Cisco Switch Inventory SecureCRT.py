    ...
    if szCommandInterface == "":
        ...
        for i in range(4):
            if szCommandInterface == "":
                ...
                crt.Dialog.MessageBox("#### You had one job ####")
                #trycounter = 5
                xInterface = ""
                break
            elif xInterface[0] == "^":
...
file.write('"Gebouw/Adres",')
file.write('"Kenmerk klant 1",')
file.write('"Kenmerk klant 2",')
file.write('"Hostname",')
file.write('"IP Adres",')
...
for line in cleaninventory:
    if len(line) >= 4:
        adres = xStraat + ', ' + xPostcode + ' ' + xPlaats
